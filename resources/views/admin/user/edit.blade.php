...
@section('meta')
    <title>{{ config("app.name") }} | {{ $sirku->title }}</title>
@endsection
...
@section('content')
    ...
    <section class="body-sign display-center-yukari">
        <div class="center-sign">
            <a href="{{ route('idare') }}" class="logo pull-left">
                <img src="{{ asset($user->foto) }}" height="54" />
            </a>
            <form class="form-horizontal" action="{{ route('makam-odasi.user.update', ['id' => $user->id]) }}" method="POST" enctype="multipart/form-data">
                {!! Form::token() !!}
                {!! Form::hidden('_method', 'UPDATE') !!}
                {!! Form::hidden('mevcut_foto', $user->foto ) !!}
                    ...
                    <div class="panel-body">
                        <form>
                            <div class="form-group mb-lg {{ $errors->has('name') ? ' has-error' : '' }}">
                                <label>Ad</label>
                                <input name="name" type="text" class="form-control input-lg" value="{{ $user->name }}" />
                            ...
                            <div class="form-group mb-lg {{ $errors->has('surname') ? ' has-error' : '' }}">
                                <label>Soyad</label>
                                <input name="surname" type="text" class="form-control input-lg" value="{{ $user->surname }}"/>
                            ...
                            <div class="form-group mb-lg {{ $errors->has('degree') ? ' has-error' : '' }}">
                                <label>Unvan</label>
                                <input name="degree" type="text" class="form-control input-lg" value="{{ $user->degree }}"/>
                            ...
                            <div class="form-group mb-lg {{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <input name="email" type="email" class="form-control input-lg" value="{{ $user->email }}"/>
                            ...
                            <div class="form-group mb-none ">
                                <div class="row">
                                <div class="col-md-12">
                                    <a class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-default btn-block" href="#modalAnim">Özgeçmiş</a>
                                </div>
                                </div>
                            </div>
                            ...
                            <div id="modalAnim" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <h2 class="panel-title">Özgeçmiş</h2>
                                    </header>
                                    <div class="panel-body">
                                        <div class="modal-wrapper">
                                            ...
                                            <div class="modal-text">
                                                    ...
                                                    <div class="note-editor">
                                                        ...
                                                        <textarea name="resume" class="note-codable"></textarea>
                                                        <div class="note-editable" contenteditable="true"
                                                             style="height: 180px;">{{ old('resume') }}</div>
                                    ...
                                    <footer class="panel-footer">
                                        <div class="row">
                                            <div class="col-md-12 text-right">
                                                <button class="btn btn-primary modal-confirm">Onayla</button>
