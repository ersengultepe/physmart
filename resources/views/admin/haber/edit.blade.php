...
@section('meta')
    <title>SDS Danışmanlık | {{ $haber->title }} Düzenleme Sayfası</title>
@endsection
...
@section('content')
    <div class="col-md-12">
        <form action="{{ route('haber.update',['id'=>$haber->id]) }}" enctype="multipart/form-data" method="POST">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Haber Düzenleme</h2>
                    <p class="panel-subtitle">
                        Kutucuklardan gerekli düzenlemeler yapılıp 'Güncelle' tıklanmalıdır.
                    </p>
                </header>
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Başlık<span class="required">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="title" class="form-control" value="{!! $haber->title !!}"
                                   placeholder="Makalenin Başlığını Yazınız " required="">
                            @if ($errors->has('title'))
                            ...
                            <div class="input-group">
                                ...
                                <select name="category_id" id="category_id" class="form-control" required="">
                                    @foreach($categories as $category)
                                        <option @if($category->id == $haber->category_id) selected
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::hidden('mevcut_foto', $haber->image) !!}
                        <div class="col-sm-9">
                            <input type="file" name="image" class="form-control">
                            <div class="thumbnail-gallery">
                                <a class="img-thumbnail lightbox" id="makale-foto" href="{{asset($haber->image)}}"
                                   data-plugin-options="{ &quot;type&quot;:&quot;image&quot; }">
                                    <img class="img-responsive" width="215" src="{{asset($haber->image)}}">
                                    <span class="zoom">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Makale İçeriği <span class="required">*</span></label>
                        <div class="col-sm-9">
                            ...
                            <div class="note-editor">
                                ...
                                <textarea name="body" class="note-codable">{!! $haber->body !!}</textarea>

                                <div class="note-editable" contenteditable="true"
                                     style="height: 180px;">{!! $haber->body !!}
                                </div>
