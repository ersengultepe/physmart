...
@section('meta')
    <title>SDS Danışmanlık | Sirkü Ekleme Sayfası</title>
@endsection
...
@section('content')
    <div class="col-md-12">
        <form action="{{ route('sirku.store') }}" method="POST">
            ...
            <section class="panel">
                ...
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Sirkü Ekleme Sayfası</h2>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" class="form-control"  value="{{ old('title') }}"
                                   placeholder="Sirkünün Adını Yazınız" required="">
