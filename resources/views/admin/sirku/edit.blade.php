...
@section('meta')
    <title>SDS Danışmanlık | {{ $sirku->title }} Düzenleme Sayfası</title>
@endsection
...
@section('content')
    <div class="col-md-12">
        <form action="{{ route('sirku.update',['id'=>$sirku->id]) }}" enctype="multipart/form-data" method="POST">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Sirkü Düzenleme</h2>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" class="form-control" value="{!! $sirku->title !!}"
                            ...
                            <div class="input-group">
                                ...
                                <select name="category_id" id="category_id" class="form-control" required="">
                                    @foreach($categories as $category)
                                        <option @if($category->id == $sirku->category_id) selected
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Sirkü İçeriği <span class="required">*</span></label>
                        <div class="col-sm-9">
                            ...
                            <div class="note-editor">
                                ...
                                <textarea name="body" class="note-codable">{!! $sirku->body !!}</textarea>

                                <div class="note-editable" contenteditable="true"
                                     style="height: 180px;">{!! $sirku->body !!}
                                </div>
