...
@section('meta')
    <title>SDS Danışmanlık | Hizmet Ekleme Sayfası</title>
@endsection
...
@section('content')
    <div class="col-md-12">
        <form action="{{ route('hizmet.store') }}" enctype="multipart/form-data" method="POST">
            ...
            <section class="panel">
                ...
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Hizmet Ekleme Sayfası</h2>
                    <p class="panel-subtitle">
                        SDS Danışmanlıkça verilen hizmet bilgilerini ekleyiniz.
                    </p>
                </header>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" class="form-control"  value="{{ old('title') }}"
                                   placeholder="Hizmetin Adını Yazınız" required="">
