...
@section('meta')
    <title>SDS Danışmanlık | {{ $hizmet->title }} Düzenleme Sayfası</title>
@endsection
...
@section('content')
    <div class="col-md-12">
        <form action="{{ route('hizmet.update',['id'=>$hizmet->id]) }}" enctype="multipart/form-data" method="POST">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Hizmet Düzenleme</h2>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" class="form-control" value="{!! $hizmet->title !!}"
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::hidden('mevcut_foto', $hizmet->image) !!}
                        <div class="col-sm-9">
                            <input type="file" name="image" class="form-control">
                            <div class="thumbnail-gallery">
                                <a class="img-thumbnail lightbox" id="makale-foto" href="{{asset($hizmet->image)}}"
                                   data-plugin-options="{ &quot;type&quot;:&quot;image&quot; }">
                                    <img class="img-responsive" width="215" src="{{asset($hizmet->image)}}">
                                    <span class="zoom">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="note-editor">
                                ...
                                <textarea name="body" class="note-codable">{!! $hizmet->body !!}</textarea>

                                <div class="note-editable" contenteditable="true"
                                     style="height: 180px;">{!! $hizmet->body !!}
                                </div>
