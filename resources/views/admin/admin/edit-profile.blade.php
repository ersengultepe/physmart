...
@section('content')
    ...
    <section class="body-sign display-center-yukari ">
        <div class="center-sign col-md-12">
            <a href="{{ route('dashboard') }}" class="logo pull-left">
                <img src="{{ asset($user->image) }}" height="54" />
            </a>
            <form class="form-horizontal" action="{{ route('admin.update', ['id' => $user->id]) }}" method="POST" enctype="multipart/form-data">
                {!! Form::token() !!}
                {!! Form::hidden('_method', 'UPDATE') !!}
                {!! Form::hidden('mevcut_foto', $user->image ) !!}
                                            ...
                                            <div class="modal-text">
                                                    ...
                                                    <div class="note-editor">
                                                        ...
                                                        <div class="note-editable" contenteditable="true"
                                                             style="height: 180px;">{!! $user->resume !!} {{ old('resume') }}</div>
