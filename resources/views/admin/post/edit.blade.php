...
@section('meta')
    <title>SDS Danışmanlık | {{ $post->title }} Düzenleme Sayfası</title>
@endsection
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <select name="lang" id="lang" class="form-control" required="required">
                                    <option value="tr" @if($post->lang == 'tr') selected @endif> Türkçe</option>
                                    <option value="en" @if($post->lang == 'en') selected @endif> English</option>
                                </select>
                                @if ($errors->has('lang'))
                                    <label for="lang" class="error">{{ $errors->first('lang') }}</label>
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        {!! Form::hidden('mevcut_foto', $post->image) !!}
                        <div class="col-sm-9">
                            <input type="file" name="image" class="form-control">
                            <div class="thumbnail-gallery">
                                <a class="img-thumbnail lightbox" id="makale-foto" href="{{asset($post->image)}}"
                                   data-plugin-options="{ &quot;type&quot;:&quot;image&quot; }">
                                    <img class="img-responsive" width="215" src="{{asset($post->image)}}">
                                    <span class="zoom">
