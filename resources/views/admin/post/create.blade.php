...
@section('meta')
    <title>{{ config("app.name") }} | Makale Ekleme Sayfası</title>
@endsection
            ...
            <section class="panel">
                ...
                <header class="panel-heading">
                    ...
                    <p class="panel-subtitle">
                        Dilediğiniz konuda makale ekleyebilirsiniz.
                    </p>
                </header>
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                @if ($errors->has('category_id'))
                                    <label for="kategori_id" class="error">{{ $errors->first('category_id') }}</label>
                                @endif
                            </div>
                        </div>
