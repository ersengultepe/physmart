...
@section('meta')
    <title>SDS Danışmanlık | Eğitim Ekleme Sayfası</title>
@endsection
...
@section('content')
    <div class="col-md-12">
        <form action="{{ route('egitim.store') }}" enctype="multipart/form-data" method="POST">
            ...
            <section class="panel">
                ...
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Eğitim Ekleme Sayfası</h2>
                    <p class="panel-subtitle">
                        Yakında gerçekleştirilecek olan eğitim bilgilerini ekleyiniz.
                    </p>
                </header>
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" class="form-control"  value="{{ old('title') }}"
                                   placeholder="Eğitimin Adını Yazınız" required="">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Eğitim İçeriği<span class="required">*</span></label>
                        <div class="col-sm-9">
