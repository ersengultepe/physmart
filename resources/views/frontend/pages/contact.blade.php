            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                        <h1>İletişim <strong>Physmart</strong></h1>
                        <span class="sub-title">Bizimle temasa geçin.</span>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row py-4">
                <div class="col-lg-7 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="650">
                    ...
                    <h2 class="font-weight-bold text-7 mt-2 mb-0">Bize Yazın</h2>
                    <p class="mb-4">Merak ettiklerinizi çekinmeden yazınız.</p>
                    ...
                    <form id="contactFormAdvanced" action="contact-us-advanced.php#contact-sent" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                ...
                                <textarea maxlength="5000" data-msg-required="Lütfen mesajınızı yazınız." rows="6" class="form-control text-3 h-auto py-2" name="message" id="message" required></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12 mb-5">
                                <input type="submit" id="contactFormSubmit" value="Gönder" class="btn btn-primary btn-modern pull-right" data-loading-text="yükleniyor...">
                            </div>
                        </div>
                    </form>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="overflow-hidden mb-1">
                        <h4 class="text-primary mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">
                            <strong>Physmart</strong> Medikal Sistemler Ltd. Şti.
                        </h4>
                    </div>
                    <div class="overflow-hidden mb-3">
                        <p class="lead text-4 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">
                            Radyoterapide kalite kontrol amaçlı kullanılan fantom, OSL dozimetre okuyucu sistemlerin yanı sıra radyasyondan korunma amaçlı Geiger Müller dedektörü, alarmlı dozimetre ve alan monitörü üretimi gerçekleştirmektedir.
                        </p>
                    </div>
                    ...
                    <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
                        ...
                        <ul class="list list-icons list-icons-style-3 mt-2">
                            <li><i class="fas fa-map-marker-alt top-6"></i> <strong>Adres:</strong> Cevat Dündar Cad., Kat:1 N:1/1/10 Ostim Teknopark/Ankara</li>
                            <li><i class="fas fa-phone top-6"></i> <strong>Tel:</strong> +90 507 745 51 87</li>
                            <li><i class="fas fa-envelope top-6"></i> <strong>Eposta:</strong> <span>info@physmart.com.tr</span> </li>
                        </ul>
                        ...
                        <h4 class="text-primary pt-5">Çalışma <strong>Saatleri</strong></h4>
                        <ul class="list list-icons list-dark mt-2">
                            <li><i class="far fa-clock top-6"></i> Pazartesi - Cuma - 9:00'dan 18:00'e kadar</li>
                            <li><i class="far fa-clock top-6"></i> Cumartesi - 9:00'dan 14:00'e kadar</li>
    ...
    <script>
        ...
        */
        ...
        var mapMarkers = [{
            ...
            html: "<strong style='font-size: large'>Physmart</strong><br>Cevat Dündar Cad. Kat:1 N:1/1/10 <br>Ostim Teknopark/Ankara<br><br><a href='#' onclick='mapCenterAt({latitude: 39.9805522, longitude: 32.7420487, zoom: 14}, event)'>[+] yakınlaştır</a>",
            icon: {
