...
!function (a, b) {
    ...
    var fd = "Ocak_February_March_April_May_June_July_August_September_October_November_December".split("_"),

        gd = "Oca_Şub_Mar_Nis_May_Haz_Tem_Ağu_Eyl_Eki_Kas_Ara".split("_"), hd = {};
    ...
    var xd = "Pazar_Pazartesi_Salı_Çarşamba_Perşembe_Cuma_Cumartesi".split("_"),
        yd = "Paz_Pts_Sal_Çar_Per_Cum_Cts".split("_"), zd = "Su_Mo_Tu_We_Th_Fr_Sa".split("_");
